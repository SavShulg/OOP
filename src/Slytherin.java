public class Slytherin extends Hogwarts {
    ...
    public Slytherin(String name, int powerOfMagic, int distance, int cunning, int determination,
    ...
    private int sum() {
        return cunning + determination + lustOfPower + ambition + resourcefulness;
    }
